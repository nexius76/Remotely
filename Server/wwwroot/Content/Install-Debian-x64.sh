...
DebianVersion=$(lsb_release -r -s|cut -d. -f 1)

wget -q https://packages.microsoft.com/config/debian/$DebianVersion/multiarch/packages-microsoft-prod.deb -O packages-microsoft-prod.deb
